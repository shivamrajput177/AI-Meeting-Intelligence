...
type Publisher interface {
	PublishTranscriptionCompleted(ctx context.Context, event entity.TranscriptionCompletedEvent) error
	PublishTranscriptionFailed(ctx context.Context, event entity.TranscriptionFailedEvent) error
}
