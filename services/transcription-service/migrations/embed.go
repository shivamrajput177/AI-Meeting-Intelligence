// Package transcriptionmigrations embeds Transcription Service's SQL
// migrations.
//
...
// importable by cmd/transcription-service via shared/dbx.
package transcriptionmigrations
